/**
 * Frame encoding tests, including conformance against the firmware.
 *
 * The vectors are generated by tools/gen_vectors.py in the firmware repo. If
 * these fail after a protocol change, the two implementations have drifted and
 * a board would be the next thing to find out.
 */
...
describe('recovery over a lossy link', () => {
    ...
    /**
     * Drops whole 20-byte chunks, which is how BLE actually fails: an entire
     * write-without-response goes missing, not scattered bits.
     */
