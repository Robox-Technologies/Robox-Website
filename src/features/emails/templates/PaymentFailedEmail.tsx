    ...
    return (
        ...
        >
            ...
            <Text style={textStyle}>
                We were unable to process your payment for your recent order on{' '}
                {date}.
                <br />
                <br />
            ...
            <BillingDetails
                rows={[{ label: 'Payment details:', value: billing }]}
            />
            ...
            <SignOff>
                Please check your payment details and try again. If you believe
                this is a mistake, please contact us at <SupportLink /> for
                assistance.
            </SignOff>
