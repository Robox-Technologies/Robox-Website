    ...
    return (
        <div className="project-rename flex items-center justify-center">
            <form autoComplete="off" className="flex gap-4 bg-white rounded-lg box-shadow " id="project-rename-form">
                <input type="text" name="projectName" id="project-name-input" value={projectName} onChange={(e) => setProjectName(e.target.value)} className="border border-gray-300 p-2 rounded-sm w-42 text-black" />
            </form>
        </div>
    )
}